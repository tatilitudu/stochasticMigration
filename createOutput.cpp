...
//--Daten in Datei schreiben---------------------------------------------------------------------------------------------------------------------------------				
	...
	gsl_vector_set(robustness, i, gsl_vector_get(robustness, i)/L);
      ...
      fprintf(statistics, "%5.1f\t", gsl_vector_get(nicheweb.migrPara, 6));
