...
gsl_vector *EvaluateRobustness(gsl_vector* evolNetwork, struct foodweb nicheweb, struct data patchwise[], struct data temp)		//evolNetwork hat (Rnum+S)*Y*5+3+S Elemente
{
